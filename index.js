...
function getCarInfoByIndex(inventory, index) {
   ...
   const myCarObject = inventory[index]

   return `This is a ${myCarObject.car_make} ${myCarObject.car_model}`
}
...
function getLastCarInfo(inventory) {
  ...
  const myCarObject = inventory[lastcarindex]
